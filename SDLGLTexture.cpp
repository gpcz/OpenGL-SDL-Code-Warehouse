 ...
 *
 * Moves the contents of src to dest, provided that dest is equal or greater in size.
 * It will put it in the upper-left-hand corner (0,0).  Make sure both surfaces
 * are 32-bit with alpha channels.
 */
...
/**
 * \brief Loads a texture from an image file and fits it into a GL-compatible size.
 * \param fileName The name of the image file.
 * \param filtering True if you want linear filtering, false if nearest-neighbor.
